...
#include "user_shell_android.h"

bool android_get_file_image(::draw2d::dib * pdib, const char * psz);
...
namespace user
{
   ...
   namespace shell
   {
      ...
      int32_t android::get_image_by_extension(per_fork * pfork, oswindow oswindow, image_key & key, COLORREF crBk)
      {
...
//      int32_t android::get_image(per_fork * pfork, oswindow oswindow, image_key imagekey, LPITEMIDLIST lpiidlAbsolute, LPITEMIDLIST lpiidlChild, const unichar * lpcszExtra, COLORREF crBk)
//      {
//
...
//                     string strIcon;
//
//                     strIcon = ::dir::system() / "config/android/app_theme" / m_strShellThemePrefix + strExtension + ".ico";
//
...
//      }
      ...
      int32_t android::get_foo_image(per_fork * pfork, oswindow oswindow, image_key imagekey, COLORREF crBk)
      {
...
//         }         synch_lock sl(m_pmutex);
      ...
      //int32_t android::get_image(per_fork * pfork, oswindow oswindow, image_key imagekey, LPITEMIDLIST lpiidlAbsolute, const unichar * lpcszExtra, COLORREF crBk)
      //{
...
//      bool android::get_icon( oswindow oswindow, const char * psz, const unichar * lpcszExtra, e_icon eicon, HICON * phicon16, HICON * phicon48)
//      {
//
//         single_lock sl(m_pmutex, true);
//
...
//      }
//
//      bool android::get_icon(per_fork * pfork, oswindow oswindow, LPITEMIDLIST lpiidlAbsolute, const unichar * lpcszExtra, e_icon eicon, HICON * phicon16, HICON * phicon48)
//      {
//
//         single_lock sl(m_pmutex, true);
//
...
//
      ...
      e_folder android::get_folder_type(::aura::application * papp, const char * lpcsz)
      {
      ...
      e_folder android::get_folder_type(::aura::application * papp, const unichar * lpcszPath)
      {
      ...
      int32_t android::get_image(per_fork * pfork, oswindow oswindow, image_key imagekey, const unichar * lpcszExtra, COLORREF crBk)
      {
...
//         SHGetMalloc(&m_pmalloc);
      ...
      int32_t android::get_image(oswindow oswindow, const string & strPath, e_file_attribute eattribute, e_icon eicon, COLORREF crBk)
      {
      ...
      int32_t android::get_image_foo(oswindow oswindow, const string & strExtension, e_file_attribute eattribute, e_icon eicon, COLORREF crBk)
      {
