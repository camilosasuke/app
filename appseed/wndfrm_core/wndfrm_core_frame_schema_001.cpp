   ...
   namespace wndfrm
   {
      ...
      namespace frame
      {
         ...
         namespace wndfrm_core
         {
            ...
            FrameSchemaHardCoded001::FrameSchemaHardCoded001(::aura::application * papp) :
               object(papp),
               frame_schema(papp)
            {
            ...
            void FrameSchemaHardCoded001::DrawBorderSide(::draw2d::graphics * pgraphics, const RECT & lpcrectClient, EBorder eside)
            {
...
//               EDock edock = m_pworkset->GetDockingManager()->GetDockState();
            ...
            void FrameSchemaHardCoded001::on_draw_frame(::draw2d::graphics * pgraphics)
            {
            ...
            void FrameSchemaHardCoded001::DrawBorder(::draw2d::graphics * pgraphics, const RECT & lpcrectClient)
            {
            ...
            void FrameSchemaHardCoded001::GetBorderRect(const RECT & lpcrectClient, LPRECT lprect, EBorder eside)
            {
            ...
            void FrameSchemaHardCoded001::on_style_change()
            {
            ...
            void FrameSchemaHardCoded001::DrawGrip(::draw2d::graphics * pgraphics, const RECT & lpcrectClient, EGrip egrip)
            {
            ...
            void FrameSchemaHardCoded001::DrawRectGrip(::draw2d::graphics * pgraphics,const RECT & rectParam)
            {
