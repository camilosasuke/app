   ...
   namespace wndfrm
   {
      ...
      namespace frame
      {
         ...
         namespace wndfrm_core
         {
            ...
            void FrameSchemaHardCoded005::DrawBorderSide(::draw2d::graphics * pgraphics, const RECT & lpcrectClient,
               EBorder eside)
            {
            ...
            void FrameSchemaHardCoded005::on_draw_frame(::draw2d::graphics * pgraphics)
            {
            ...
            void FrameSchemaHardCoded005::DrawBorder(::draw2d::graphics * pgraphics, const RECT & lpcrectClient)
            {
            ...
            void FrameSchemaHardCoded005::Draw3dRectSide(::draw2d::graphics * pgraphics,const RECT & rectParam,EBorder eborder,COLORREF crTopLeft,COLORREF crBottomRight)
            {
...
#define GRIP_LARGE 30
            ...
            void FrameSchemaHardCoded005::DrawRectGrip(::draw2d::graphics * pgraphics,const RECT & rectParam)
            {
            ...
            void FrameSchemaHardCoded005::DrawGripSet(::draw2d::graphics * pgraphics, const RECT & lpcrectClient)
            {
